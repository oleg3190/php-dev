...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_infinite_loading__ = __webpack_require__(38);
...
window.io = __webpack_require__(39);
...
Vue.component('message-form', __webpack_require__(88));
var app = new Vue({
    el: '#app'
});
...
Component.options.__file = "resources/assets/js/components/messageForm.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-13d133a4", Component.options)
  } else {
    hotAPI.reload("data-v-13d133a4", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    window.Echo.channel("chat").listen("Message", function (_ref) {
      ...
      switch (message.action) {
        case "remove":
          _this.messages.splice(message.index, 1);
          break;
        case "create":
  ...
  methods: {
    isAuthor: function isAuthor(message) {
      if (this.user) {
        return this.user.id === message.user_from;
      }
    },
    ...
    deleteMessage: function deleteMessage(message, index) {
      ...
      axios({
        method: "post",
        url: "/cabinet/message/destroy/" + message.id,
        data: {
          owner: this.user.id,
          index: index
        }
    ...
    infiniteHandler: function infiniteHandler($state) {
      ...
      axios({
        ...
        if (response.data.data.length) {
          ...
          _this2.page += 1;
          (_messages = _this2.messages).push.apply(_messages, _toConsumableArray(response.data.data));
          $state.loaded();
        } else {
          $state.complete();
        }
  ...
  return _c(
    ...
    [
              ...
              _vm.textNull
                ? _c(
                    ...
                    [
                      ...
                      _vm._v(" Сообщение не может быть пустым.\n    ")
                    ]
                  )
                : _vm._e(),
              _vm._v(" "),
              ...
              _c("div", { staticClass: "controls" }, [
                _c("div", { staticClass: "col-md-12" }, [
                  _c("div", { staticClass: "form-group" }, [
                    _c("label", { attrs: { for: "message_text" } }, [
      ...
      _vm._l(_vm.messages, function(message, index) {
        return _c("div", { key: index, staticClass: "row wall-message" }, [
          _vm.loading && _vm.arrIndex == index
            ...
            : _vm._e(),
          _vm._v(" "),
          _vm.isAuthor(message) || _vm.isAdmin()
            ? _c(
                "button",
                {
                  staticClass: "close",
          ...
          _c("div", { staticClass: "col-md-11 col-xs-10" }, [
            _c("p", [_c("strong", [_vm._v(_vm._s(message.author))])]),
            _vm._v(" "),
            _c("blockquote", [_vm._v(_vm._s(message.text))])
          ])
        ])
      }),
      _vm._v(" "),
      _c(
        ...
        [
          ...
          _c("div", { attrs: { slot: "no-more" }, slot: "no-more" }, [
            _vm._v("Больше нет сообщений")
          ]),
          _vm._v(" "),
          _c("div", { attrs: { slot: "no-results" }, slot: "no-results" }, [
            _vm._v("Ещё никто не оставил сообщение")
          ])
        ]
      )
    ],
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-md-1 col-xs-2" }, [
      _c("img", {
        staticClass: "img-circle user-avatar",
        attrs: { src: "http://www.gravatar.com/robohash/hash.jpg", alt: "" }
      })
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-13d133a4", module.exports)
  }
}
